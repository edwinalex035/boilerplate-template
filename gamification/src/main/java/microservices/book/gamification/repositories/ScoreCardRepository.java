...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
   ...
   */
  @Query("SELECT SUM(s.score) FROM microservices.book.gamification.models.ScoreCard s WHERE s.userId = :userId GROUP BY s.userId")
   ...
   */
  @Query("SELECT NEW microservices.book.gamification.models.LeaderBoardRow(s.userId, SUM(s.score)) FROM microservices.book.gamification.models.ScoreCard s GROUP BY s.userId ORDER BY SUM(s.score) DESC")
